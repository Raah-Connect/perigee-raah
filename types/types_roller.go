...
func (c *Client) ConfigureKeys(ctx context.Context, point, encryptPublic, authPublic string, breach bool, signingAddress string, privateKey *ecdsa.PrivateKey) (*Transaction, error) {
...
func (c *Client) GetManagementProxyType(ctx context.Context, point, signingAddress string) (string, error) {
	pointInfo, err := c.GetPoint(ctx, point)
	if err != nil {
		return "", err
	}
...
func (c *Client) GetUnsignedTx(ctx context.Context, method string, params interface{}) (string, error) {
...
func (c *Client) addSignature(ctx context.Context, method string, params interface{}, privateKey *ecdsa.PrivateKey) error {
...
func (c *Client) TransferPoint(ctx context.Context, point string, reset bool, newOwnerAddress string, signingAddress string, privateKey *ecdsa.PrivateKey) (*Transaction, error) {
...
func (c *Client) CanTransfer(ctx context.Context, point, address string) (bool, error) {
	pointInfo, err := c.GetPoint(ctx, point)
	if err != nil {
		return false, fmt.Errorf("get point info: %w", err)
	}
...
func (c *Client) CanSpawn(ctx context.Context, point, address string) (bool, error) {
	pointInfo, err := c.GetPoint(ctx, point)
	if err != nil {
		return false, fmt.Errorf("get point info: %w", err)
	}
...
func (c *Client) GetRollerConfig(ctx context.Context) (*RollerConfig, error) {
...
func (c *Client) GetAllPending(ctx context.Context) ([]PendingTx, error) {
...
func (c *Client) GetPendingByAddress(ctx context.Context, address string) ([]PendingTx, error) {
	params := struct {
		Address string `json:"address"`
	}{
		Address: address,
...
func (c *Client) WhenNextBatch(ctx context.Context) (*BatchInfo, error) {
...
func (c *Client) GetShips(ctx context.Context, address string) ([]ShipInfo, error) {
	params := struct {
		Address string `json:"address"`
	}{
		Address: address,
...
func (c *Client) GetUnspawned(ctx context.Context, point string) ([]ShipInfo, error) {
	params := struct {
		Ship string `json:"ship"`
	}{
		Ship: point,
...
func (c *Client) SelectDataSource(ctx context.Context, useRoller, useAzimuth bool) (string, error) {
	if useRoller {
...
func (c *Client) GetPoint(ctx context.Context, point interface{}) (*Point, error) {
...
func (c *Client) Spawn(ctx context.Context, parentPoint, spawnPoint interface{}, newOwnerAddress, signingAddress string, privateKey *ecdsa.PrivateKey) (*Transaction, error) {
...
func (c *Client) GetSpawned(ctx context.Context, point interface{}) ([]ShipInfo, error) {
	pointNum, err := ValidatePoint(point, false)
	if err != nil {
		return nil, fmt.Errorf("validate point: %w", err)
	}
